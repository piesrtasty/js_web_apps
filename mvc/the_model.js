...
The model is where all the applications data objects are stored. For example a User Model would contain a list of users, their attributes, and any logic associated specifically with that  model.
